$(document).ready(function() {
	...
	$('#content_container').loadJSON(homeJSON);
...
function initialize() {
	...
	$.each(homeJSON.schools, function(i,obj) {
	...
	// for (var key in homeJSON.schools) {
	// 	var schooladdress = homeJSON.schools[key].address;
	// 	geocoder.geocode( { 'address': schooladdress}, function(results, status) {
	//     	if (status == google.maps.GeocoderStatus.OK) {
	//         	var schoolmarker = new google.maps.Marker({
	//             	map: schoolmap,
	//             	position: results[0].geometry.location,
	//             	title: homeJSON.schools[key].school,
	//             	icon: image
	//         	});
 ...
 //    	});
	...
	// 	var schooladdress = schooladdresses[i] + ' near ' + homeJSON.cityzip;
